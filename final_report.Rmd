...
mean((mean(test_1$obesrate)-test_1$obesrate)^2)
...
# the random forest model (MSE of 0.006502064) performed better than just guessing the mean obesity rate in both the test (0.01054306) and train (0.01081579) set.
